document.addEventListener('DOMContentLoaded', () => {
    ...
    function getPushUnsupportedMessage() {
        if (isIOSDevice() && !isStandaloneMode()) {
            return '通知をお使いになるには、ホーム画面への追加が必要です。Safariの共有ボタン（見当たらなければ「•••」）から「ホーム画面に追加」を選んでいただけます。\n\n通知はお使いにならなくても大丈夫です。ただ、ホーム画面への追加は、していただけると安心です。ブラウザ（SafariやChrome）のまま使うと、しばらく使わない間に、これまでの記録が消えてしまうことがあります。ブラウザ側の仕組みなので、アプリからは防げません。ホーム画面に追加すると、記録は消えずに残ります。\n\nご不明点は遠慮なく永田までご連絡ください。';
        }
