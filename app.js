document.addEventListener('DOMContentLoaded', () => {
    console.log('App v12.0.10 starting (20260925)...');
    // === 要素の取得 ===
    ...
    const AUTO_MESSAGES = [
        ...
        { zones: [65],                         text: 'ほどよく活気あるエネルギーが、あなたの中にありますね。その心地よい熱量を、ぜひ味わってみてください。' },
        { zones: [50],                         text: '今、この瞬間に、静かに留まっていますね。その「おだやかさ」は、身体のどのあたりで一番感じますか？' },
        { zones: [35],                         text: '優しい休息の空気が流れているようですね。あなたのシステムが、ゆっくり充電されていくのを許してあげてください。' },
