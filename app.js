document.addEventListener('DOMContentLoaded', () => {
    ...
    const messages = {
        'high': [
            '頭の中で警報アラームが鳴っているのですね。一生懸命に状況に対処しようとしている大切なサインです。',
            '焦りやそわそわは、身体があなたを守ろうと頑張っている証拠です。今は少しだけ、お水を一口飲んでひと息ついてみませんか？',
            '今、少しだけ視線を上げて、部屋の中にある『四角いもの』を3つ、ゆっくり見つけてみましょう。（ヘルプ・ナウ！）',
            'もしできれば、壁を両手でギュッと押して、筋肉に力を入れてみてください。身体に溜まったエネルギーを少し逃がしてあげましょう。'
        ],
        'mid': [
            '『悪くない』『マシ』に気づけたこと、とても大きな一歩です。その感覚のまま、少しだけそこにとどまってみましょう。',
            'ほんの少しでも『いい感じ』を見つけられたご自身を褒めてあげてください。波があるのは、神経系がしなやかな証拠です。',
            'その『マシな感じ』は、身体のどのあたりで感じますか？ 少しだけ、そこに優しく意識を向けてみましょう。',
            '『いつもの自分』がちゃんとここにいますね。そのホッとする感覚を、一緒に味わいましょう🍵'
        ],
        'low': [
            '今は何も感じないことでシステムを保護する、大切な冬眠の時間ですね。無理に動かず、重力に身体を預けてみてください。',
            'バタンキューと休むことも、生き残るための立派な防衛反応です。何もしないことを選択できたご自身を、まずは労ってあげてくださいね。',
            'エネルギーが底をついている時は、無理に引き上げようとしなくて大丈夫です。温かい毛布にくるまって、安全を確保してくださいね。',
            '今はただ、呼吸が自然に出たり入ったりするのを見守るだけで大丈夫ですよ。'
        ]
    };
