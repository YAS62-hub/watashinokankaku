document.addEventListener('DOMContentLoaded', () => {
    console.log('App v12.0.9 starting (20260925)...');
    // === 要素の取得 ===
    ...
    const AUTO_MESSAGES = [
        ...
        { zones: [100],                        text: 'もし、息苦しさなどがあれば、お腹の奥底から「ヴーーー」と低い声（音）を長く吐き出してみませんか？お腹の振動を感じてみましょう。' },
        ...
        { zones: [85],                         text: '息苦しさを感じるような時は、お腹の奥底から「ヴーーー」と低い声（音）を長く吐き出してみませんか？お腹の振動を感じてみましょう。' },
        ...
        { zones: [15, 0],                      text: '身体の重さを感じる時などは、お腹の奥底から「ヴーーー」と低い声（音）を長く吐き出してみませんか？お腹の振動を感じてみましょう。' },
