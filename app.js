document.addEventListener('DOMContentLoaded', () => {
    ...
    // ▼ Web Push用設定 ▼
    // ▼ 検証用（kankaku-push-worker-dev）。本番Workerとは別環境で、動作確認専用。
    ...
    const PALETTE_GROUPS = [
        { score: 100, title: 'すごくハイ（ゾーンの外）', words: ['しゅぽしゅぽと機関車のよう', '戦闘モード', '逃走モード', '頭が真っ白になる', 'カッとなる', '息が浅い', '視界が狭い', '暴走列車に乗っているよう', '破裂しそう', '頭が真っ白', '暴走列車'] },
        ...
        { score: 0,   title: 'すごくロー（ゾーンの外）', words: ['電源オフ', '感覚が薄い', '麻痺している', '何も感じない', '泥のよう', 'システムを保護するためのシャットダウン', '自分がどこにいるかわからない', '気配を消す', '宇宙空間に浮いているよう', '深い冬眠', 'システム保護中', '自分がわからない', 'つめたい', '強制終了', '強制スリープ', '冬眠モード', '電池切れ'] }
    ];
