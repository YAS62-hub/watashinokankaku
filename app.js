document.addEventListener('DOMContentLoaded', () => {
    console.log('App v12.0.11 starting (20260926)...');
    // === 要素の取得 ===
    ...
    // 記録後メッセージ。1つの文を1回だけ書き、どの状態のときに出すかを zones に並べる。
    // （2026-09-17: 以前は状態ごとに同じ文を書き写していて、1文を直すのに最大7か所を触る必要があった。
    //   言葉づくりの「棚卸し_返す言葉_記録後メッセージ.csv」と同じ、文ごとに状態へ○を付ける形にそろえた。並び順もCSVのNoと同じ）
    // 100=すごくハイ／85=ハイと大丈夫のあいだ／65=活気／50=凪／35=休息／15=ローと大丈夫のあいだ／0=すごくロー
    // ★よく似た文（「底をつきそうな時は」と「底をついている時は」など）は、別の文として残してある。まとめるかは言葉づくりで決める
    const AUTO_MESSAGES = [
        { zones: [100, 85],                    text: '一生懸命に状況に対処しようとしている身体からの大切なメッセージかもしれません。もしよければ、ゆっくり10回足踏みをして、足の裏の感覚に気づいてみませんか？（スローダウン）' },
        { zones: [100, 85],                    text: 'あなたの大切な反応は、身体があなたを守ろうと頑張っている証拠です。今は少しだけ、お水を一口飲んでひと息ついてみませんか？（ヘルプ・ナウ！）' },
        { zones: [100, 85],                    text: 'もし今、身体の中に強いエネルギーやざわつきを感じているなら、それはあなたを守ろうとシステムが一生懸命に働いているサインかもしれません。' },
        { zones: [100, 85],                    text: '身体がキュッと張り詰めている時は、少しだけ視線を上げて、部屋の中にある『四角いもの』を3つ、ゆっくり見つけてみませんか？' },
        { zones: [100, 85],                    text: '行き場のないエネルギーを感じたら、もしできれば、壁を両手でギュッと押して筋肉に力を入れてみてください。少しだけ外に逃がしてあげましょう。' },
        { zones: [100, 0],                     text: '圧倒されるような感覚を、記録してくれましたね。今はただ、安全な場所でやり過ごすだけで十分です。' },
        // 2026-09-25: ヴーサウンドの3つの文（状態ごとに条件が違った）を、この2文にまとめ直した（C17・シート292〜299行）
        { zones: [100, 85, 15, 0],             text: 'もしよろしければ、お腹の奥底から「ヴーーー」と低い声（音）を長く吐き出してみませんか？声の振動や、そのあとの身体の感じを、ゆっくり感じてみるのもいいかもしれません。' },
        { zones: [100, 85, 15, 0],             text: 'もしよろしければ、お腹の奥底から「ヴーーー」と低い声（音）を長く吐き出してみませんか？声の振動や、そのあとの身体の感じに、ゆっくり好奇心を寄せてみるのもいいかもしれません。' },
        { zones: [100, 85, 15, 0],             text: 'もしよろしければ、ご自身の腕や足を「ポンポン」と優しく叩いたり、少しギュッとさすったりして、身体の輪郭を確かめてみませんか？' },
        { zones: [100, 85, 65],                text: '少しだけ奥歯に力を入れたりゆるめたり、口をぽかんと開けてみるのはどうでしょう。しばらく繰り返すとどんなことに気がつきますか？' },
        { zones: [100, 85, 15, 0],             text: 'もしよろしければ、一度つま先立ちをしてから、かかとを「トン、トン、トン…」と床に下ろす動きを数回繰り返してみませんか？' },
        { zones: [100, 85, 65, 50, 35, 15, 0], text: '今、身体の中で「一番マシなところ」「少しだけ楽なところ」はどこですか？そこに少しだけ、好奇心を向けてみましょう。' },
        // 2026-09-25: リソース箱の2文を1文にまとめ、大丈夫の3つだけに1文を足した（C16・シート282〜291行）
        { zones: [100, 85, 65, 50, 35, 15, 0], text: 'リソース箱や、ふと心に浮かぶものの中から、今お気に召すものを一つ、眺めてみたり、実際にしてみたりするのはどうでしょうか？' },
        { zones: [65, 50, 35],                 text: 'もしよろしければ、あなたのリソースを探してみたり、見つけたものをリソース箱に入れてみたりするのはどうでしょうか？' },
        { zones: [85],                         text: '張り詰めている感覚に意識が向いていますね。もしよければ、部屋の中で「青いもの」を一つ探してみるのも助けになるかもしれません。' },
        { zones: [85],                         text: '頭の中が忙しい時などは、100から順番に「3つずつ数字を引いて」数えてみませんか？（100、97、94…）' },
        { zones: [85, 65],                     text: 'フワフワする時は、一度つま先立ちをしてから、かかとを「トン」と床に下ろす動きを数回繰り返してみませんか？' },
        { zones: [85, 65, 35, 15, 0],          text: '座ったまま、海藻のように身体をゆっくり左右に揺らしてみませんか？背骨の滑らかな動きを感じてみましょう。' },
        // 2026-09-26: 大丈夫の3つの「〜ですね」の文を、それぞれ3文に入れ替えた（シート300〜308行。どれも1つの状態だけに置く）
        { zones: [65],                         text: 'もし今、心地よい熱量や弾むような感じがあれば、それが身体のどのあたりにあるか、少しだけ味わってみませんか。' },
        { zones: [65],                         text: 'エネルギーが心地よく回っているようなら、その感じが身体の中でどんなふうに広がっていくか、ゆっくり眺めてみるのもいいかもしれません。' },
        { zones: [65],                         text: '活気のある中に、少し急ぐ感じや疲れが混ざっていることもあるかもしれません。どちらも、今のあなたの大切な感覚です。' },
        { zones: [50],                         text: 'もし身体のどこかに「おだやかさ」のようなものがあるとしたら、それはどのあたりでしょうか。はっきりしなくても、大丈夫です。' },
        { zones: [50],                         text: '「大丈夫」にも、いろいろな感じがあるかもしれません。静かな大丈夫も、少しせわしない大丈夫も、どちらも今のあなたの感覚です。' },
        { zones: [50],                         text: 'もしよければ、今の身体の感じを、良い・悪いを決めずに、しばらくただ眺めてみませんか。' },
        { zones: [35],                         text: 'もし身体が休みたがっているようなら、今は充電の時間なのかもしれません。急がずに、ゆっくりで大丈夫です。' },
        { zones: [35],                         text: '少し疲れを感じながらも、大丈夫の範囲にいる。そんなときもあるかもしれません。その両方がある今の感じを、そのままにしておいてもいいのかもしれません。' },
        { zones: [35],                         text: 'ひと休みすることに、特別な理由はいらないのかもしれません。' },
        { zones: [15, 0],                      text: '今は何も感じない・感じづらくすることであなたを守る、大切な冬眠のような時間かもしれません。無理に動かず、重力に身体を預けてみてください。' },
        { zones: [15, 0],                      text: 'バタンキューと休むことも、生き残るための立派な防衛反応です。時に「何もしないこと」もあなたの大切な意図的な選択だと感じます。今のあなたを、まずは労ってあげてくださいね。' },
        { zones: [15, 0],                      text: '身体が重く感じたり、動きたくないような時は、システムがあなたを休ませようとしている大切な『冬眠』の時間かもしれません。' },
        { zones: [15, 0],                      text: 'もし感覚が遠く感じられても、それは生き残るための立派な防衛反応です。無理に引き上げず、今は重力に身体を預けてみてください。' },
        { zones: [15],                         text: 'エネルギーが底をつきそうな時は、何もしないことを選択しても大丈夫です。温かい毛布にくるまるなどして、まずは安全を確保してくださいね。' },
        { zones: [15, 0],                      text: '感覚の変化を丁寧にキャッチしていますね。もしよければ、足の裏や背中、お尻などが「床や背もたれ、座面、壁などに支えられている感覚」があるかどうか、ゆっくり感じてみませんか。また、わからない、感じない、というのも大事な感覚です。' },
        { zones: [15, 0],                      text: '遠く感じる時などは、少し視線を動かして、部屋の中にある『温かそうな色のもの』を1つ、目で触るように眺めてみませんか？' },
        { zones: [15, 0],                      text: 'もしよければ、両手でご自身をギュッと抱きしめて（セルフハグ）、ご自身の身体の温かさを少しだけ味わってみませんか？' },
        { zones: [0],                          text: 'エネルギーが底をついている時は、何もしないことを選択して大丈夫です。温かい毛布にくるまるなどして、まずは安全を確保してくださいね。' },
        { zones: [0],                          text: 'あなたのシステムが、あなたを懸命に守ろうとしているサインかもしれません。今は無理に動かず、ただ安全な場所で休むことをご自身に許してあげてくださいね。' },
        // 2026-09-25: シート268〜281行（9/3・9/5に採用済み。C18）。言葉づくりのCSVにはまだ無いので、ここでは末尾に置いた
        // ★「気づきづらい」と「遠い」の2文は、言い回し違いを両方入れる（C18）
        { zones: [50, 35],                     text: 'もしよければ、手を机や身のまわりのものに触れて、その質感や温度と、しばらく一緒にいてみませんか。' },
        { zones: [35],                         text: '夜、眠るときに、ベッドの上にいる自分の感覚と、しばらく一緒にいてみるのもいいかもしれません。' },
        { zones: [65, 50],                     text: 'もしよければ、ゆ〜〜〜〜っくり立ち上がってみませんか。体重や姿勢が変わっていく途中で、どこに力が入って、どこが抜けていくでしょうか。' },
        { zones: [65, 50],                     text: '立っていても座っていても、心地よい、ちょうどいいと感じる重心を探してみるのはどうでしょう。少し体重を移してみると、何か変わるかもしれません。' },
        { zones: [50, 35, 15],                 text: '今、身体の中で「良くも悪くもない」「マシ」と感じるところがあれば、もう少しだけ、そこに留まってみませんか。' },
        { zones: [15, 0],                      text: 'もしあなたが今、ご自身の感覚に気づきづらい、よくわからないと感じていたとしたら、それも大切な気づきです。' },
        { zones: [15, 0],                      text: 'もし今、ご自身の感覚が遠い、よくわからないと感じていたとしたら、それも大切な気づきです。' }
    ];

    // 状態ごとの一覧（'100' → その状態で出す文の配列）。記録後の表示と、設定画面の「表示のイメージ」が使う
    const AUTO_MESSAGES_POOL = {};
    AUTO_MESSAGES.forEach(({ zones, text }) => {
        zones.forEach(zone => {
            (AUTO_MESSAGES_POOL[zone] = AUTO_MESSAGES_POOL[zone] || []).push(text);
        });
    });
    ...
    // ★iPhone向けの文（下のif）は、チュートリアル4枚目（renderTutorialSlide4）と
    //   同じ「記録が消える／防げない／追加すれば残る」の3点を、一字一句そろえてある。
    //   片方だけ直すと、同じ話が2つの別問題に見えるので、変えるときは必ず両方を直すこと。
    //   文の作り方は3原則：結論を1行目に置く／指示語（その・これ）を使わない／ぼかさない。
    // ★この文は、チュートリアル4枚目より1つ短い（「ブラウザ側の仕組みなので、アプリからは
    //   防げません」を置いていない）。ここは通知をオンにしようとして止まった場面なので、
    //   要るのは「何が起きるか」と「どうすればよいか」の2つだけ、という判断（2026-09-05）。
    //   足すと枠に収まらず、末尾の連絡先の行が隠れる（実機で確認済み）。
    // ★ここを「・」付きの箇条書きに戻さないこと（2026-09-05に実機で確認して外した）。
    //   この枠はiPhone本体が出すもので、折り返した2行目を字下げできない。
    //   「・」を付けると2行目が「・」より左から始まり、かえって区切りが読みにくくなる。
    //   本物の箇条書きにするには、アプリ自前の枠が要る（20箇所のalertごと直す話・保留中）。
    function getPushUnsupportedMessage() {
        if (isIOSDevice() && !isStandaloneMode()) {
            return '通知をお使いになるには、ホーム画面への追加が必要です。Safariの共有ボタン（見当たらなければ「•••」）から「ホーム画面に追加」を選んでいただけます。\n\n通知はお使いにならなくても大丈夫です。ただ、ホーム画面への追加は、していただけると安心です。\n\nブラウザ（SafariやChrome）のまま使うと、しばらく使わない間に、これまでの記録が消えてしまうことがあります。\n\nホーム画面に追加すると、記録は消えずに残ります。\n\nご不明点は遠慮なく永田までご連絡ください。';
        }
