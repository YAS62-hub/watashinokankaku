document.addEventListener('DOMContentLoaded', () => {
    ...
    const AUTO_MESSAGES = [
        ...
        { zones: [100, 85, 65, 50, 35, 15, 0], text: 'あなたの心の中にある「安全なリソース箱（宝箱）」を開けて、一番お気に入りのものを一つ、頭の中で眺めてみませんか？' },
        { zones: [100, 85, 65, 50, 35, 15, 0], text: '「リソース箱（宝箱）」を開けて、今お気に召すものを一つ、眺めてみたり、実際にしてみたりするのはどうでしょうか？' },
